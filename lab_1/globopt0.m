...
WorkList(1) = struct( 'Box', X, 'Estim', inf(Y), 'EstimUp', sup(Y) );
LeadingBars = [];
...
%   через Leading, а ведущую (наименьшую) оценку обозначаем LeadEst 
    ...
    LeadingBars = [LeadingBars WorkList(Leading).Box];
    ...
    Rec1 = struct( 'Box', D1, 'Estim', inf(Y1), 'EstimUp', sup(Y1) );
    Rec2 = struct( 'Box', D2, 'Estim', inf(Y2), 'EstimUp', sup(Y2) );
